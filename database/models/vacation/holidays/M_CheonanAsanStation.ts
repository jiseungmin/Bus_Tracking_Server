...
export default mongoose.models.VactionHolidaysCheonanAsanStation || mongoose.model('VactionHolidaysCheonanAsanStation', cheonanAsanStationSchema, 'VactionSaturday/Holidays');