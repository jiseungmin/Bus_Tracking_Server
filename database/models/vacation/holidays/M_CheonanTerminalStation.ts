...
export default mongoose.models.HolidaysCheonanTerminalStation || mongoose.model('HolidaysCheonanTerminalStation', cheonanTerminalStationSchema, 'VactionSaturday/Holidays');
