...
export default mongoose.models.VactionWeekdayCheonanAsanStation || mongoose.model('VactionWeekdayCheonanAsanStation', cheonanAsanStationSchema, 'VactionWeekday');
