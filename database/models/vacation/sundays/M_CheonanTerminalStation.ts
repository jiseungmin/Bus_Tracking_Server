...
export default mongoose.models.VactionSundaysCheonanTerminalStation || mongoose.model('VactionSundaysCheonanTerminalStation', cheonanTerminalStationSchema, 'VactionSunday');
